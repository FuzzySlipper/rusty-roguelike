...
| `libs/platform/`                                                | Browser HTTP, frames, input, resize, motion, and pixel-ratio ports             | typecheck; consumers                                  |
...
| `libs/feature-game/`                                            | Full-window canvas plus initiative/action/status/log presentation overlays     | real desktop/mobile expedition                        |
| `libs/theme/`                                                   | Product tokens and global geometry                                             | build; browser smoke                                  |
| `apps/app/`                                                     | Angular application binding only                                               | build                                                 |
| `apps/app-e2e/`                                                 | Real Rust-served movement, reveal, picking, log, desktop/mobile certification  | `pnpm run verify:browser`                             |
