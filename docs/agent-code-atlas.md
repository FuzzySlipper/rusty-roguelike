...
| `src/RustyRoguelike.NativeProduct/` | NativeAOT assembly marker and minimal development-host bundle/content | NativeAOT publish |
| `src/scripts/exercise-native-product.sh` | maintained real-host proof | `bash src/scripts/exercise-native-product.sh` |
